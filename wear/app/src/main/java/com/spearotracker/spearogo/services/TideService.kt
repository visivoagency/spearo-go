 ...
 * was neither. It anchored its M2 term to the **Unix epoch** rather than to the
 * Moon, discarded the latitude it was passed, and mapped every location on
...
class TideService @Inject constructor() {
    fun calculate(
        latitude: Double,
        longitude: Double,
        timeSeconds: Double = System.currentTimeMillis() / 1000.0
    ): TideData? = null
}
